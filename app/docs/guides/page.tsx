            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {/* Card */}
                  <Link href="/docs/cursor-setup" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-indigo-500/50 hover:shadow-lg hover:shadow-indigo-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-1 flex items-center justify-center text-white text-sm font-bold">
                          <FaCode className="w-4 h-4" />
                        </div>
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-indigo-400 transition-colors">Cursor 설치 및 설정</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      AI 코딩을 위한 Cursor 에디터 설치부터 기본 설정까지 5분 완성
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 5분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 1,234명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-indigo-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>

                  <Link href="/docs/first-prompt" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-indigo-500/50 hover:shadow-lg hover:shadow-indigo-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-1 flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-indigo-400 transition-colors">첫 프롬프트 작성법</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      AI가 정확히 이해하는 프롬프트 작성 3단계 공식
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 7분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 892명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-indigo-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>

                  <Link href="/docs/nextjs-quickstart" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-indigo-500/50 hover:shadow-lg hover:shadow-indigo-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-1 flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-indigo-400 transition-colors">5분 만에 Next.js 시작</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      Next.js 프로젝트 생성부터 localhost 실행까지
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 5분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 2,103명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-indigo-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <Link href="/docs/clerk-auth" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-2 flex items-center justify-center text-white text-sm font-bold">
                          <FaLock className="w-4 h-4" />
                        </div>
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-emerald-400 transition-colors">Clerk 로그인 추가하기</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      구글, 깃허브 소셜 로그인을 10분 만에 추가
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 10분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 1,567명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>

                  <Link href="/docs/supabase-setup" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-2 flex items-center justify-center text-white text-sm font-bold">
                          <FaDb className="w-4 h-4" />
                        </div>
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-emerald-400 transition-colors">Supabase DB 연결</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      데이터베이스 생성부터 Next.js 연결까지
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 12분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 1,234명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  ...
                  <Link href="/docs/env-variables" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-2 flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-emerald-400 transition-colors">환경변수 설정하기</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 5분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 943명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-emerald-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <Link href="/docs/module-not-found" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-4 flex items-center justify-center text-white text-sm font-bold">
                          <FaExclamationTriangle className="w-4 h-4" />
                        </div>
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-red-400 transition-colors">Module not found 해결</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      패키지 설치 에러 3분 안에 해결하기
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 3분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 3,421명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-red-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>

                  <Link href="/docs/hydration-error" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-4 flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-red-400 transition-colors">Hydration Error 해결</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      Next.js 고질병 에러 원인과 해결법
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 5분</span>
                  ...
                  <Link href="/docs/deployment-404" className="group bg-zinc-900 border border-zinc-800 rounded-xl p-5 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/5 transition-all hover:-translate-y-0.5">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg gradient-4 flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <div>
                          <h3 className="font-bold text-zinc-100 group-hover:text-red-400 transition-colors">배포 후 404 에러</h3>
                        </div>
                      </div>
                    </div>
                    <p className="text-sm text-zinc-400 mb-4 line-clamp-2">
                      Vercel 배포 후 페이지가 안 뜰 때
                    </p>
                    <div className="flex items-center justify-between pt-3 border-t border-zinc-800">
                      <div className="flex items-center gap-3 text-xs text-zinc-500">
                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 4분</span>
                        <span className="flex items-center gap-1"><Users className="w-3 h-3" /> 1,632명</span>
                      </div>
                      <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-red-400 group-hover:translate-x-1 transition-all" />
                    </div>
                  </Link>
